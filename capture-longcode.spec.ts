...
const NAME = 'QA_AUTO_0812 CapAlr'; // same shape as the failing guards name
const CODE = 'QA_AUTO_0812_CAL'; // 16 chars - guards uses codes like this; the working capture used 6
