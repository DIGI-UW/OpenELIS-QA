...
- **Δ-W (partial) — the mapping-page test picker.** The analyzer-type picker was fixed; this one
  **was not re-tested** because focus could not be driven into it on the retest. The assertion is
  left as-is and **flagged** — if TC-ANZ-M3-08 starts failing, that is good news.
